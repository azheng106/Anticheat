...
public class ReflectionUtils {
    private static final String serverVersion = Bukkit.getServer().getClass()
    ...
    public static Collection<?> getCollidingBlocks(Player player, Object axisAlignedBB) {
        ...
        return (Collection<?>) getInvokedMethod(getBlocks, world, axisAlignedBB);
    }

    public static Object getBoundingBox(Player player) {
        return getInvokedMethod(getMethod(EntityPlayer, "getBoundingBox"), getEntityPlayer(player));
    }

    public static Object modifyBoundingBox(Object box, double minX, double minY, double minZ,
        ...
        try {
            return getNMSClass("AxisAlignedBB")
                    ...
                    .newInstance(newminX, newminY, newminZ, newmaxX, newmaxY, newmaxZ);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
